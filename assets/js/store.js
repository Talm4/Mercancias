...
import { aggregateRecords, buildDataModel, buildInsights, filterKey, filterRecords, problemasRegistro } from "./data-engine.js";

const listeners = new Set();
const FILTER_DEFAULT = {
  busqueda: "", desde: "", hasta: "", semestre: "todos", asistio: "",
  base: "", grupo: "", curso: "", instructor: "", salon: "", estado: "",
...
export const store = {
  ...
  filtrosActivos() {
    const labels = { busqueda: "Búsqueda", desde: "Desde", hasta: "Hasta", semestre: "Semestre", asistio: "Asistencia", base: "Base", grupo: "Grupo", curso: "Curso", instructor: "Instructor", salon: "Salón", estado: "Estado", soloDuplicados: "Duplicados", soloRevision: "Revisión" };
...
export const ESTADO_HTML = {
  loading: '<span class="status-dot status-loading"></span> Sincronizando',
  online: '<span class="status-dot status-online"></span> En línea',
  partial: '<span class="status-dot status-partial"></span> Datos parciales',
  error: '<span class="status-dot status-offline"></span> Sin conexión',
};
